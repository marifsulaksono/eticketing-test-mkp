...
func (st *showtimeService) GetAllShowtimes(ctx context.Context) ([]entities.Showtime, error) {
	return st.Repo.GetAllShowtimes(ctx)
}

func (st *showtimeService) GetShowtimeById(ctx context.Context, id int) (entities.Showtime, error) {
